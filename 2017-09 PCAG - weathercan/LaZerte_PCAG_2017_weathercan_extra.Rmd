...
<div class = "highlightbox" style = "top: 23%; right: 57%; width: 168px; height: 30px;"></div>
...
<div class = "highlightbox" style = "width: 100px; height: 380px; right: 19%; top: 32.5%"></div>
...
<div class = "highlightbox" style = "bottom: 40%; right: 40%; height: 35px; width: 65px;"></div>
<div class = "highlightbox" style = "bottom: 40%; right: 17.5%; height: 35px; width: 65px;"></div>
...
```{r, echo = FALSE}
w %>% 
  dplyr::select(station_id, date, temp, temp_dew, rel_hum, wind_dir)
```
...
<div class = "highlightbox" style = "left: 18.25%; top: 55%; height:32%; width:8%"></div>
...
<div class = "highlightbox" style = "left: 34.75%; top: 41%; height:32%; width:8%"></div>
<div class = "highlightbox" style = "right: 14%; top: 41%; height:32%; width:5%"></div>
