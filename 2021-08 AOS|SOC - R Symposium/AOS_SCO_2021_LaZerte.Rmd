...
![:img right: 275px, bottom: 25px, 200px, Black text reads 'Brandon University' next to a shield with two open books above an inverted V and three stalks of wheat](https://www.brandonu.ca/communications/files/Brandon-University-Horizontal-Logo-1-Colour-Black-RGB.png)
...
![:img left: 33%, bottom: 19%, 175px, Black text reads 'Brandon University' next to a shield with two open books above an inverted V and three stalks of wheat](https://www.brandonu.ca/communications/files/Brandon-University-Horizontal-Logo-1-Colour-Black-RGB.png)
