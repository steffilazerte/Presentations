...
library(knitr)
opts_chunk$set(echo = TRUE, cache = TRUE, out.width = "100%", dpi = 300)
...
```{r}
write_csv(manitoba, "manitoba_2018-07-01.csv")
```
...
```{r, echo = FALSE, fig.asp = 0.48, fig.width = 10}
...
write_csv(w, "brandon_historical.csv")
```
