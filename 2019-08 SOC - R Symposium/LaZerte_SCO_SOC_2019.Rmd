...
![:img left: 450px, top: 75px, 200px, , ](./Figures/logos/ubrandon.png)
...
--
- This may (will) lead to frustration
...
.footer[(I made these slides with **R**markdown)]
...
--
- Taxomonic data with [**`taxize`**](https://github.com/ropensci/taxize)
...
![:img left: 50px, bottom: 100px, 35%, , ](./Figures/seewave_logo.png)
...
![:img left: 575px, bottom: 30px, 15%, , ](./Figures/bbsBayes_logo.png)

--
- Systematic reviews with [**`litsearchr`**](https://elizagrames.github.io/litsearchr/) (.rblue[Here @ 1:30pm])
![:img right: 150px, bottom: 30px, 15%, , ](./Figures/litsearchr_logo.png)
...
---
# R for Ornithologists: Stay tuned...




**QR Code for presentation location**

![:img , bottom: 22%, 150px, , ](./Figures/logos/ubrandon.png)

![:info v, right: 25px, bottom: 250px]()
